...
public class SojEventHADistJob {
    public static void main(String[] args) throws Exception {
        ...
        sojEventDistStream.addSink(producerFactory.getHaProducer(
                        getString(PRODUCER_ID),
                        getString(RHEOS_HA_SERVICE_URL),
                        getInteger(RHEOS_HA_PRODUCER_PROBE_INTERVAL_MIN),
                        new RawSojEventWrapperValueSerializerSchema(),
                        new RawSojEventWrapperSelector()))
