...
/**
 * Behave as same as org.apache.flink.formats.parquet.avro.ParquetAvroWriters,
 * except adding compression.
 */
public class ParquetAvroWritersWithCompression {
     ...
     */
    private ParquetAvroWritersWithCompression() {
    }
}
